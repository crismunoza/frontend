...
export class ResetpassComponent implements OnInit {
  ...
  restablecerContrasenia() {
    this.submit = true;
    if (this.resetpass.controls['contrasenia'].invalid || this.resetpass.controls['repetircontrasenia'].invalid) {
      return;
    }
    const rut = this.resetpass.controls['rut'].value;
    const contrasenia = this.resetpass.controls['contrasenia'].value;
    const repetirContrasenia = this.resetpass.controls['repetircontrasenia'].value;
    ...
    this.PostService.cambiarContrasena(rut, contrasenia).subscribe(res => {
      if (res.msg === 'Se actualizó la contraseña exitosamente') {
        Swal.fire({
          position: 'center',
          icon: 'success',
      ...
      } else if (res.msg === 'Error al actualizar la contraseña') {
        // Aquí puedes manejar el mensaje recibido en el bloque else if
        Swal.fire({
          position: 'center',
          icon: 'error',
